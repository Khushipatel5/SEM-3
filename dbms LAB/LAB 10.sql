...
CREATE VIEW DISPLAY1 AS SELECT * FROM STUDENT_INFO WHERE BKLOG=0;
...
CREATE VIEW STU_BKLOG AS SELECT RNO,NAME,BKLOG FROM STUDENT_INFO WHERE  BKLOG>5 AND NAME LIKE 'M%' 
