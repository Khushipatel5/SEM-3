...
SELECT FIRSTNAME FROM STUDENT2 WHERE FIRSTNAME LIKE '_____'

--3. Retrieve the first name & last name of students whose city name ends with a & contains six characters.
SELECT FIRSTNAME,LASTNAME FROM STUDENT2 WHERE CITY LIKE'_____A'
...
SELECT FIRSTNAME FROM STUDENT2 WHERE WEBSITE IS NULL AND FIRSTNAME LIKE'_____'
...
SELECT FIRSTNAME FROM STUDENT2 WHERE  FIRSTNAME LIKE '____' OR FIRSTNAME LIKE '_____'
